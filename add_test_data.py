# Añadir datos de prueba para verificar el sistema
...
def add_test_data():
    ...
    try:
        ...
        ''', (
            ...
            'Pasta, Pollo', 'Frutas', 'Ninguna', 'Ninguna', 'Ninguna',
            'Alta', 'Flexible', 'Le gusta probar', 'Cereal con leche',
