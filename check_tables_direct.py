# Verificación directa de tablas en la base de datos

import sqlite3

def check_tables_direct():
    """Verificar directamente qué tablas existen"""
    try:
        ...
        print("📋 VERIFICACIÓN DIRECTA DE TABLAS:")
        ...
        if adults_exists and children_exists:
            ...
            # Crear tabla adults si no existe
            ...
            # Crear tabla children si no existe
