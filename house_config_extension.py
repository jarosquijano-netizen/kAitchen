# House Configuration Extension for Database class
# This file contains the house configuration methods to be added to database.py
...
# Database.save_house_config = save_house_config
# Database.get_house_config = get_house_config
